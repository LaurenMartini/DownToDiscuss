...
class Events {
    ...
    var points:Int
    var usersInterested: Int
    var usersThere: Int
    
    init(user: Profile, discussionTitle: String, location: CLLocationCoordinate2D, funTopic: String, intenseTopic: String, description:String, points:Int, usersInterested: Int, usersThere: Int) {
        self.user = user
