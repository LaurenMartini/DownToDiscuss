...
var currentUser = Profile(name: currUser, userPic: UIImage(named: "6.jpg")!, userRating: UIImage(named: "fourStars.png")!, hostStatus: 0, totalPoints: 0)

//default user database
var user1 = Profile(name:"Alice", userPic: UIImage(named: "1.jpg")!, userRating: UIImage(named: "fourStars.png")!, hostStatus: 1, totalPoints: 100)
var user2 = Profile(name:"Bob", userPic: UIImage(named: "2.jpg")!, userRating: UIImage(named: "threeStars.png")!, hostStatus: 1, totalPoints: 50)
var user3 = Profile(name:"Charlie", userPic: UIImage(named: "4.jpg")!, userRating: UIImage(named: "fiveStars.png")!, hostStatus: 1, totalPoints: 200)
var user4 = Profile(name:"David", userPic: UIImage(named: "3.jpg")!, userRating: UIImage(named: "twoStars.png")!, hostStatus: 1, totalPoints: 10)
var user5 = Profile(name:"Ellie", userPic: UIImage(named: "5.jpg")!, userRating: UIImage(named: "threeStars.png")!, hostStatus: 1, totalPoints: 25)
